        ...
        <FadeIn>
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">View your WhatsApp message sending history</p>
              </div>
            </div>
          </div>
          ...
          <Stagger staggerDelay={0.1} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <AnimatedCard animation="slideUp" delay={0.4}>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Failed campaigns</p>
              </CardContent>
            </AnimatedCard>
          </Stagger>
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1">
                  <div className="relative">
                    ...
                    <Input
                      placeholder="Search by template name or group..."
                      value={searchQuery}
          ...
          <AnimatedCard animation="fadeIn" delay={0.6} className="mt-6">
            <CardHeader>
              ...
              <CardDescription>
                Detailed history of your message sending campaigns
              </CardDescription>
            </CardHeader>
            <CardContent>

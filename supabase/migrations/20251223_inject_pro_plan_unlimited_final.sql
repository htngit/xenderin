...
-- User ID: 3aa07c0f-208-46e5-a483-03731e3a3e24
...
-- Step 1: Ensure Pro plan exists in pricing_plans table
INSERT INTO pricing_plans (
    ...
    'monthly',
    100000.00,
    9999, -- Unlimited quota
    '["Unlimited messages", "Priority support", "Analytics"]'::jsonb,
    true,
    0
...
-- Step 2: Update or create subscription record for the user
INSERT INTO subscriptions (
    ...
    NULL, -- next_billing_date will be set by default
...
-- Step 3: Update user_quotas to reflect Pro plan with unlimited messages
...
-- Step 4: Insert into user_quotas if record doesn't exist
...
SELECT
    '3aa07c0f-2208-46e5-a483-03731e3a3e24' AS user_id,
    '3aa07c0f-2208-46e5-a483-03731e3a3e24' AS master_user_id,
    'pro' AS plan_type,
    99999 AS messages_limit,
    0 AS messages_used,
...
BEGIN
    ...
    RAISE NOTICE 'Messages limit: Unlimited (99999)';
    RAISE NOTICE 'Plan features: Unlimited messages, Priority support, Analytics';
END $$;

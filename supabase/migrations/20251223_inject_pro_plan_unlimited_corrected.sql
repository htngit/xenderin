...
INSERT INTO subscriptions (
    ...
    'f38f62c4-878e-403e-85a6-4007bc724b11',
    'pro',
    'monthly',
    'active',
    100000.00,
...
UPDATE user_quotas SET
    ...
    is_active = true,
    updated_at = NOW()
WHERE user_id = 'f38f62c4-878e-403e-85a6-4007bc724b11'
   OR master_user_id = 'f38f62c4-878e-403e-85a6-4007bc724b11';
...
SELECT
    'f38f62c4-878e-403e-85a6-4007bc724b11' AS user_id,
    'f38f62c4-878e-403e-85a6-4007bc724b11' AS master_user_id,
    'pro' AS plan_type,
    999999 AS messages_limit,
    0 AS messages_used,
...
BEGIN
    ...
    FROM subscriptions
    WHERE master_user_id = 'f38f62c4-878e-403e-85a6-4007bc724b11'
    AND plan_type = 'pro'
